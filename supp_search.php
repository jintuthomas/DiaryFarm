...
<div>    <form action="" method="POST" class="formSearch fl">
  ...
  <h1>Supplier List</h1><br><br><br>
    ...
    <?php
        ...
        $sq2="SELECT * FROM supplier_reg WHERE `fname` LIKE '%".$se."%' ";
...
<table border="5" width="100%" class="table table-striped" background="\project\images\table2.jpg" >
    <tr>
	<th>NAME</th>
	<th>LOCATION</th>
	<th>PHONE NUMBER</th>
