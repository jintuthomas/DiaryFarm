...
if($login)
{
    ...
    $sq2="select * from admin_bank where loginid='$id'";
                    ...
                    <form method="POST" class="register-form" id="myForm">
                        <div class="form-row">
                           ...
                           <div class="form-input">
                                ...
                                <div class="form-input">
                                    <label for="blank_name">E-mail</label>
...
$q1="INSERT INTO `admin_bank`(`loginid`,`pname`, `bank_name`, `branch`, `acc_no`, `ifsc`, `acc_type`, `phone`, `email`, `balance`) VALUES
      ('$lid','$name','$bname','$branch','$accno','$ifsc','$type', '$ph','$email','$amount')";
...
<br><br>
        <div class="container">
            <div class="signup-content">
                ...
                <?php
            include "dbconnect.php";
           $sel="SELECT * FROM `admin_bank` where loginid='$id'";
                    ...
                    <form method="POST" class="register-form" id="myForm">
                        <div class="form-row">
                           ...
                           <div class="form-input">
                                ...
                                <div class="form-input">
                                    <label for="phone_number" class="required">Phone number</label>
                                    <input type="text" name="phone_number" id="phone_number" value="<?php echo $row["phone"]; ?>" />
                                </div>
                                <div class="form-input">
                                    <label for="blank_name">E-mail</label>
                                ...
                                <div class="form-input">
                                    <label for="payable" class="required">Amount</label>
                                    <input type="text" name="amount" id="amount" value="<?php echo $row["balance"]; ?>" />
                                </div>
                            </div>
                        </div>
...
$q1="UPDATE `admin_bank` SET pname='$name', bank_name='$bname', branch='$branch', acc_no='$accno', ifsc='$ifsc', 
    acc_type='$type', phone='$ph', email='$email', balance='$amount'where loginid='$id'";
