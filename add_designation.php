...
function fvalidate(r)
{
  ...
  var desig=document.getElementById("desig").value;
    ...
    var pattern1 = new RegExp("^[a-zA-Z ]*$"); 
      if(!pattern1.test(document.myform.desig.value)) 
	  {
      alert("Error: Please enter valid name for new Openings!");
      myform.desig.focus();
    return false;
...
<form action="" method="POST" name="myform" class="login-form"  onsubmit=" fvalidate()" autocomplete="off">


     <h2>Add New Designation to Our Society</h2>
     <br><br>
    <input type="text" name="desig" id="desig" placeholder="New Designation" />
      <button name="submit" onclick="return fvalidate(this)">ADD</button>
...
$q1="INSERT INTO `designation`(`post`) VALUES('$desig')";
