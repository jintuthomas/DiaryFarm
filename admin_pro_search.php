...
<form action="" method="POST" name="listpro" style="margin-left:350px;">
...
$sq2="SELECT * FROM product WHERE `ptname` LIKE '%".$se."%' ";
...
<h1 style="margin-left:200px;">VIEW ALL PRODUCTS</h1>
...
<tr>
<td> 
  <img src="/project/<?php echo $pic; ?> " width="100px;" height="100px;">
</td>
