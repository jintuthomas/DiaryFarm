...
require_once($_SERVER['DOCUMENT_ROOT']."/project/cust_page/RazorpayKit/razorpay-php/config.php");// ee config fiiliu ningalude secret keyum api keeyum set cheyyuka


include($_SERVER['DOCUMENT_ROOT']."/project/cust_page/RazorpayKit/razorpay-php/Razorpay.php");//ivide path set cheyyuka
...
$filename=$_SERVER['DOCUMENT_ROOT']."/project/cust_page/Bill/".$b.$razor_payment_id.".pdf";
$relname=$b.$razor_payment_id.".pdf";
$file="/project/cust_page/Bill/".$b.$razor_payment_id.".pdf";
