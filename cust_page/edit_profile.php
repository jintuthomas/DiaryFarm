							...
							<div class="media-body" style="margin-left:100px;">
								<div class="personal_text">
                                    ...
                                    <ul class="list basic_info">
                                       ...
                                       <input name="ad1" type="text" id="ad1" value="<?php  echo $row["address1"]  ?>"  ><br>
                                       ...
                                       <input name="ad3" type="text" id="ad3" value="<?php  echo $row["address3"]  ?>" style="margin-left:90px;"></li>
                                        ...
                                        &nbsp;  <input id="phone" type="tel" name="phone" value="<?php echo $row["phone"];  ?>"></li>
      ...
      $a3=$_POST['ad3'];
       ...
       $c=$_POST['phone'];
        $d=$_POST['email'];
         ...
         $sql="UPDATE cust_reg SET address1='$a1',address2='$a2',address3='$a3',phone='$c',email='$d' WHERE loginid ='$id'";
