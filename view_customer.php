...
<div class="row filterGroup">  
  <form action="admin_cust_search.php" method="POST" class="formSearch fl" autocomplete="off">
...
<form action="" border="1" method="POST" enctype="multipart/form-data" style="margin-left:250px;">
    <br><br><br><br><br>
	<h2 style="font-size:40px;"><b>Customers list</h2>
	<br><br>
...
$sel="SELECT * FROM `cust_reg` where status=0 and veri=1";
...
$i=$row['idproof'];
?>
<a href="<?php echo $i; ?>" style="color:Green;">Proof</a>
</td>
