...
function fvalidate(e)
{
  ...
  if(salary == "")
    ...
    {
      alert("Please enter the salary greaterthan 100");
      document.getElementById("salary").focus();
      return false;
    }
}
...
<div class="row filterGroup">   
 <form action="" method="POST" class="formSearch fl">
   ...
   <a href="salary_chart.php" class="button" style="float:right;">Create Salary Chart</a>
   <br><br><br>
   <BR>

<label style="MARGIN-LEFT:1300PX;">SALARY CHART</LABEL><BR><BR>
   <table border="5"  cellpadding="12" background="\project\images\table2.jpg" style="float:right;">
    <tr>
...
?>
     ...
     <h1><b><i style="margin-left:360px;">UPDATED STAFF'S SALARY</i></b></h1><br><br><br>
<table border="5"  cellpadding="12" background="\project\images\table2.jpg" style="margin-left:350px;">
    <tr>
