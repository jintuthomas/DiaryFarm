...
<!--             END GROUP -->             
   ...
   <br><br><br><br><br>
   <h1><b><i style="margin-left:0px;">TODYAS COLLECTION OF MILK</i></b></h1><br><br><br>
...
$sel="SELECT * FROM `supp_milk` where session='Morning' AND date1='$da' ";
...
$s=mysqli_query($con,"select sum(quantity) from `supp_milk` where session='Morning' AND date1='$da'");
  $r=mysqli_fetch_array($s,MYSQLI_ASSOC);
   ...
   $s=mysqli_query($con,"select sum(total) from `supp_milk` where session='Morning' AND date1='$da'");
   $r=mysqli_fetch_array($s,MYSQLI_ASSOC);
...
$sel="SELECT * FROM `supp_milk` where session='Afternoon' AND date1='$da'";
...
$s=mysqli_query($con,"select sum(quantity) from `supp_milk` where session='Afternoon' AND date1='$da'");
  $r=mysqli_fetch_array($s,MYSQLI_ASSOC);
   ...
   $s=mysqli_query($con,"select sum(total) from `supp_milk` where session='Afternoon' AND date1='$da'");
   $r=mysqli_fetch_array($s,MYSQLI_ASSOC);
...
<form action="" method="POST" name="liststaff" id="form1">
   ...
   <br><br><br><br><br>
   <h1><b><i style="margin-left:500px;">SUPPLIER'S MILK LIST</i></b></h1><br><br><br>
