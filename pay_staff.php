...
<form action="" method="POST" name="liststaff">
   ...
   <br><br><br><br><br>
   <h1><b><i style="margin-left:500px;">PAYMENT FOR STAFF FORM</i></b></h1><br><br><br>
   <label>Manager</label>
...
while($row=mysqli_fetch_array($res,MYSQLI_ASSOC))
{
    ...
    $sq=mysqli_query($db,"select max(date) as date from acct where loginid='$lid' ");
...
<td><a href="pay_staff_action.php?id=<?php echo $lid; ?>" style="color:white"; class="button">PAY</a></td>
...
<td><a href="pay_action_otherstaff.php?id=<?php echo $lid; ?>" style="color:white"; class="button">PAY</a></td>
