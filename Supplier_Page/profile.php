  ...
  <body class="bg">
       ...
       <form action="" Method="POST" enctype="multipart/form-data">
        ...
        <li class="active">
          ...
          <li>
              <a href="pay_form.php"><span class="fa fa-bank mr-3 notif"></span>Add Bank Info</a>
          </li>
          <li>
            <a href="changepwd.php"><span class="fa fa-edit mr-3"></span> Change Password</a>
          </li>
							...
							<div class="media-body" style="margin-left:100px;">
								<div class="personal_text">
									...
									<ul class="list basic_info">
									   <li><label  style="color:white;">&nbsp;<i class="lnr lnr-home"></i>  &nbsp;&nbsp;<?php echo $row["address"]; echo"&nbsp;,"; echo $row["address2"];  echo"&nbsp,"; echo $row["address3"]; ?></label></li>
									  
                                       <li><label  style="color:white;">&nbsp;<i class="lnr lnr-calendar-full"></i> &nbsp;&nbsp;<?php echo $row["reg_date"]; ?>&nbsp;(Reg. Date & Time)</label></li>
										<li><label  style="color:white;">&nbsp;<i class="lnr lnr-phone-handset"></i> &nbsp;&nbsp; <?php echo $row["contact"]; ?></label></li>
