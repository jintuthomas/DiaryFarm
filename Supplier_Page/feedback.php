...
return true;
  ...
  <body class="bg">
       ...
       <!-- <div class="custom-menu">
        ...
        <li class="active">
            <a href="supplier_home.php"><span class="fa fa-home mr-3"></span>Back</a>
          </li>
...
$s=mysqli_query($con,"select * from supplier_reg where loginid='$id'");
...
$q1="INSERT INTO `feedback`(`loginid`, `n1`, `n2`, `sub`, `feedback`) VALUES ('$lid','$n1','$n2','$sub','$feed')";
