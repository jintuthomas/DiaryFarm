  ...
  <body class="bg">
       ...
       <!-- <div class="custom-menu">
        ...
        <ul class="list-unstyled components mb-5">
          <li class="active">
          <a href="supplier_home.php"><span class="fa fa-home mr-3"></span> Home</a> </li>
        ...
        <h2 class="mb-4">View our products</h2>


              

<form class="example" action="search.php" style="margin:auto;max-width:300px; margin-left:1000px;">
  ...
  <button type="submit"><i class="fa fa-search" name="submit"></i></button>
    	...
    	<div class="container">
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				...
    				<ul class="product-category">
    					<li><a href="products.php" class="active" style=" font-size:20px;">All Products</a></li>
						<li><a href="milk_view.php" style="color:green; font-size:20px;">Milk </a></li>
						<li><a href="milk_product_view.php"style="color:green; font-size:20px;">Milk Products</a></li>
						<li><a href="other_product_view.php"style="color:green; font-size:20px;">Other Products</a></li>
          ...
          <?php
                      ...
                      $sel="SELECT * FROM `product` where exp_veri=0";
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="price-sale"><i class="fa fa-rupee"></i> <?php echo $row['price']; ?></span></p>
		    					</div>
	    					</div>
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							
	    							<a href="view_single_product.php?id=<?php  echo $pid;?>" class="buy-now d-flex justify-content-center align-items-center mx-1">
