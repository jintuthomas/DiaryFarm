...
<html lang="en">
<?php
require_once($_SERVER['DOCUMENT_ROOT']."/project/Supplier_Page/RazorpayKit/razorpay-php/config.php");
?>
  <head>
  ...
  <body class="bg">
    ...
    ?>
        <div class="wrap-input100 validate-input bg0 rs1-alert-validate" >
                    ...
                    <label>Name      :</label>&nbsp;<label><?php  echo $row["fname"]; echo "&nbsp";  echo $row["lname"];  ?></label><br>
                    <label>Address   :</label><br><label>
                        <?php  echo $row["address"]; echo "<br>"; echo $row["address2"]; echo "<br>"; echo $row["address3"];  ?></label><br>
                    <label>E-mail    :</label>&nbsp;<label><?php  echo $row["email"]  ?></label><br>
                    <label>Phone No. :</label>&nbsp;<label><?php  echo $row["contact"]  ?></label><br>
                </div>
				</div>
				...
				<button class="contact100-form-btn" name="submit">
                    ...
                    <!--<a href="pay.php?id=<?php  echo $cid;?>" class="contact100-form-btn" name="sub">
                    <span>
							Proceed
							<i class="fa fa-long-arrow-right m-l-7" aria-hidden="true"></i>
						</span>
...
<script>
        ...
        {
            $.ajax({
            url: '/project/Supplier_Page/RazorpayKit/checkoutsuccess.php',//ivide nammade payment tablilinte code oke kedakkunna php file specify cheyyuka
            type: 'POST',
            data: {
