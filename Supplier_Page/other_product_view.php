...
<title>See Our Products</title>
  ...
  <body class="bg">
       ...
       <!-- <div class="custom-menu">
        ...
        <h2 class="mb-4">Other Types of Products</h2>
    	...
    	<div class="container">
          ...
          <?php
                      ...
                      $sel="SELECT * FROM `product` where pname='Other Products' and exp_veri=0";
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="/project/<?php echo $row['picture']; ?>" alt="">
