...
<div id="page">
    ...
    $q=$r['count(cartid)'];
    ?>
                            <li class="cart"><a href="cart.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart[<?php echo $q; ?>]</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="gototop js-top">
    <a href="#" class="js-gotop"><i class="fa fa-angle-up" style="font-size:20px;"></i></a>
</div>
