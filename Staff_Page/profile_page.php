...
img {
  ...
  <body class="bg">
     ...
     <div class="img bg-wrap text-center py-4" style="background-image: url(/project/Staff_Page/images/bg2.jpg);">
	<div class="user-logo">
    <?php
							...
							<div class="media-body" style="margin-left:100px;">
								<div class="personal_text">
									...
									<ul class="list basic_info">
                                       <li><label  style="color:white;">&nbsp;<i class="lnr lnr-home"></i>  &nbsp;&nbsp;<?php echo $row["location"]; ?></label></li>
                                       <li><label  style="color:white;">&nbsp;<i class="lnr lnr-user"></i>  &nbsp;&nbsp;<?php echo $row["gender"]; ?></label></li>
                                       <li><label  style="color:white;">&nbsp;<i class="lnr lnr-calendar-full"></i> &nbsp;&nbsp;<?php echo $row["regi_date"]; ?>&nbsp;(Reg. Date & Time)</label></li>
										<li><label  style="color:white;">&nbsp;<i class="lnr lnr-phone-handset"></i> &nbsp;&nbsp; <?php echo $row["phone_no"]; ?></label></li>
