...
<!--     SIDE AREA -->
  ...
  <br><br><br><br>
        <a href="delete_rate.php" style="margin-left:1300px; color:red; font-size:20px;">Create New list</a>
...
<form action="" method="POST" name="rate" class="login-form"  onsubmit=" fvalidate()" autocomplete="off">
    ...
    <input type="text" name="snf" id="snf" placeholder="SNF" />
    <input type="text" name="price" id="price" min="0.0" placeholder="Updated Price"/>
...
$q1="INSERT INTO `rate`(`fat`, `snf`, `price`) VALUES
    ('$fat','$snf','$price')";
