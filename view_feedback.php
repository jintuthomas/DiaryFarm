...
<form action="" method="POST" name="liststaff">
   ...
   <br><br><br><br><br>
   <h1><b><i style="margin-left:300px;">VIEW FEEDBACK</i></b></h1><br><br><br>



     
<table border="5" cellpadding="8" width="50%"  style="margin-left:300px;">
    <tr>
...
<tr>
  ...
  <td> 
   <?php echo $row['n1']; echo "&nbsp";  echo $row['n2']; ?>
  </td>
<td> 
   <?php 
        echo $row['sub'];
